...
NODE_CLASS_MAPPINGS = {
    "WanVideoModelLoaderEnhanced": WanVideoModelLoader,
    "WanVideoVAELoaderEnhanced": WanVideoVAELoader,
    "WanVideoLoraSelectEnhanced": WanVideoLoraSelect,
    "WanVideoLoraSelectByNameEnhanced": WanVideoLoraSelectByName,
    "WanVideoSetLoRAsEnhanced": WanVideoSetLoRAs,
    "WanVideoLoraBlockEditEnhanced": WanVideoLoraBlockEdit,
    "WanVideoTinyVAELoaderEnhanced": WanVideoTinyVAELoader,
    "WanVideoVACEModelSelectEnhanced": WanVideoVACEModelSelect,
    "WanVideoExtraModelSelectEnhanced": WanVideoExtraModelSelect,
    "WanVideoLoraSelectMultiEnhanced": WanVideoLoraSelectMulti,
    "WanVideoBlockSwapEnhanced": WanVideoBlockSwap,
    "WanVideoVRAMManagementEnhanced": WanVideoVRAMManagement,
    "WanVideoTorchCompileSettingsEnhanced": WanVideoTorchCompileSettings,
    "LoadWanVideoT5TextEncoderEnhanced": LoadWanVideoT5TextEncoder,
    "LoadWanVideoClipTextEncoderEnhanced": LoadWanVideoClipTextEncoder,
    }

NODE_DISPLAY_NAME_MAPPINGS = {
    "WanVideoModelLoaderEnhanced": "WanVideo Model Loader Enhanced",
    "WanVideoVAELoaderEnhanced": "WanVideo VAE Loader Enhanced",
    "WanVideoLoraSelectEnhanced": "WanVideo Lora Select Enhanced",
    "WanVideoLoraSelectByNameEnhanced": "WanVideo Lora Select By Name Enhanced",
    "WanVideoSetLoRAsEnhanced": "WanVideo Set LoRAs Enhanced",
    "WanVideoLoraBlockEditEnhanced": "WanVideo Lora Block Edit Enhanced",
    "WanVideoTinyVAELoaderEnhanced": "WanVideo Tiny VAE Loader Enhanced",
    "WanVideoVACEModelSelectEnhanced": "WanVideo VACE Module Select Enhanced",
    "WanVideoExtraModelSelectEnhanced": "WanVideo Extra Model Select Enhanced",
    "WanVideoLoraSelectMultiEnhanced": "WanVideo Lora Select Multi Enhanced",
    "WanVideoBlockSwapEnhanced": "WanVideo Block Swap Enhanced",
    "WanVideoVRAMManagementEnhanced": "WanVideo VRAM Management Enhanced",
    "WanVideoTorchCompileSettingsEnhanced": "WanVideo Torch Compile Settings Enhanced",
    "LoadWanVideoT5TextEncoderEnhanced": "WanVideo T5 Text Encoder Loader Enhanced",
    "LoadWanVideoClipTextEncoderEnhanced": "WanVideo CLIP Text Encoder Loader Enhanced",
    }
