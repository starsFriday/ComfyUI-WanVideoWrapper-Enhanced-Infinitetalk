...
from .nodes_sampler_mprompt import NODE_CLASS_MAPPINGS as SAMPLER_MPROMPT_NODE_CLASS_MAPPINGS, NODE_DISPLAY_NAME_MAPPINGS as SAMPLER_MPROMPT_NODE_DISPLAY_NAME_MAPPINGS
...
NODE_CLASS_MAPPINGS.update(SAMPLER_MPROMPT_NODE_CLASS_MAPPINGS)
...
NODE_DISPLAY_NAME_MAPPINGS.update(SAMPLER_MPROMPT_NODE_DISPLAY_NAME_MAPPINGS)
